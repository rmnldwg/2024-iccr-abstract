...
\centering{
\includegraphics{manuscript_files/static/schematic_and_graph.pdf}
}
...
\centering{
\includegraphics{manuscript_files/figures/prevalence_by_subsite.pdf}
}
...
%We included patients with tumors in the oral cavity, gum (C03), floor of mouth (C04), other/unspecified parts of the mouth (C06), other/unspecified parts of tongue (C02), palate (C05), and tumors in the oropharynx (C10), tonsil (C09), base of tongue (C01),  
...
\centering{
\includegraphics{manuscript_files/figures/cluster_assignments.pdf}
}
...
\centering{
\includegraphics{manuscript_files/figures/prevalence_comparison.pdf}
}
